...
description: Masterize your privacy by running Moltbot locally # Add post description (optional)
img: moltbot.png # Add image post (optional)
...
2. **Test Browser Automation:**
   ...
   ![image](../assets/img/moltbot/testBrowser.png)
